...
///
/// Program that uses Kasiski Examination to output a list of probable key lengths
...
///
/// performKasiskiExamination is a function that prints out a list of repeated strings and their distances,
/// then a list of the distances and their factors, then finally a list of the number of occurences of factors.
///
void performKasiskiExamination(const std::string &ciphertext)
{
    ///
